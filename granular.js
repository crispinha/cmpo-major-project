var granular = (() => {
  ...
  // src/Granular.js
  var Granular_exports = {};
  __export(Granular_exports, {
    Granular: () => Granular
  });
  ...
  var Granular = class {
    ...
    set(state) {
      this.state = (0, import_lodash.merge)(this.state, state);
    }
    setBuffer(data) {
    ...
    getVoice(id) {
      return (0, import_lodash.find)(this.state.voices, (voice) => voice.id === id);
    }
    startVoice(options = {}) {
      ...
      class Voice {
        ...
        update(options2 = {}) {
          ...
          if (options2.volume) {
            this.volume = options2.volume;
          }
        }
        play() {
          const _innerPlay = () => {
            const grain = self2.createGrain(this.position, this.volume);
            this.grains[this.grainsCount] = grain;
            this.grainsCount++;
            if (this.grainsCount > 20) {
              this.grainsCount = 0;
            }
            const density = map(self2.state.density, 1, 0, 0, 1);
    ...
    createGrain(position, volume) {
      ...
      const disconnectTime = (attack + release) * 1e3;
      setTimeout(() => {
        gain.disconnect();
      }, disconnectTime + 200);
  ...
  return __toCommonJS(Granular_exports);
})();
/**
 * @license
